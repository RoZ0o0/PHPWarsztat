...
<div class="vertical-nav bg-white" id="sidebar">
  ...
  <ul class="nav flex-column bg-white mb-0">
    <li class="nav-item">
      <a href="dashboard.php" class="<?php if ($page == "home") {
    ...
    <li class="nav-item">
      <a href="pracownicy.php" class="<?php if ($page == "pracownik") {
                                        echo "nav-link text-dark bg-light";
                                      } else {
                                        echo "nav-link text-dark";
                                      } ?>">
    ...
    <li class="nav-item">
      <a href="uslugi.php" class="<?php if ($page == "uslugi") {
                                    echo "nav-link text-dark bg-light";
                                  } else {
                                    echo "nav-link text-dark";
                                  } ?>">
    ...
    <li class="nav-item">
      <a href="faktury.php" class="<?php if ($page == "faktury") {
                                      echo "nav-link text-dark bg-light";
                                    } else {
                                      echo "nav-link text-dark";
                                    } ?>">
    ...
    <li class="nav-item">
      <a href="klienci.php" class="<?php if ($page == "klienci") {
                                      echo "nav-link text-dark bg-light";
                                    } else {
                                      echo "nav-link text-dark";
                                    } ?>">
    ...
    <li class="nav-item">
      <a href="pojazdy.php" class="<?php if ($page == "pojazdy") {
                                      echo "nav-link text-dark bg-light";
                                    } else {
                                      echo "nav-link text-dark";
                                    } ?>">
    ...
    <li class="nav-item">
      <a href="galeria.php" class="<?php if ($page == "galeria") {
                                      echo "nav-link text-dark bg-light";
                                    } else {
                                      echo "nav-link text-dark";
                                    } ?>">
    ...
    <li class="nav-item">
      <a href="warsztaty.php" class="<?php if ($page == "warsztaty") {
                                        echo "nav-link text-dark bg-light";
                                      } else {
                                        echo "nav-link text-dark";
                                      } ?>">
